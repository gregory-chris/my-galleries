...
export default function CreateGalleryModal({ isOpen, onClose, onGalleryCreated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await onGalleryCreated(name, description);
      // Reset form
      setName('');
      setDescription('');
      onClose();
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-2xl font-bold text-gray-900">Create Gallery</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="gallery-description" className="block text-sm font-medium text-gray-700 mb-2">
